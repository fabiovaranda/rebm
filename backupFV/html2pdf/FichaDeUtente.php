<?PHP
	...
	include_once(dirname(__FILE__)."/../DataAccess.php");
	$da = new DataAccess();
	$res = $da->getUtente($_GET['f']);
	
	//mostrar o utente -> html
	...
	<div class='ink-grid'>
			...
			<h4> <font color='#1A9018'> Ficha de Utente </font></h4>		
				...
				<table style='width:100%;  border-collapse:separate; border-spacing:0 5px;' >
					...
					<tr>
						...
						<td colspan='2'>
							<input type='text' name='NIF' onkeypress='return event.charCode >= 48 && event.charCode <= 57' id='NIF'maxlength='9' style='width:90%' required value='$row->NIF'/> 
						</td>
						<td colspan='3'>
