...
if (isset($_POST['NIF']) || isset($_GET['n'])){ //pesquisar utentes por NIF
	...
	if (isset($_POST['NIF'])){
		...
		$res = $da->getUtentes($nif, $nome, $idFrontOfficeSinalizador, $emailTecnico, 
								$interesseProfissional, $escolaridade, $situacaoEmprego, $estado/*, $pagina*/);
	}else{
		$nif = $_GET['n'];
...
if (isset($_POST['NIF']) || isset($_GET['f']) || isset($_GET['n'])){	
	...
	echo "<tr><td colspan='6' align='center'>";
			echo "<a href='#' onclick='firstPage()'><img src='img/first.png' style='width:40px'/></a>";
			echo "<a href='#' onclick='previousPage()'><img src='img/left.png' style='width:40px'/></a>";
			echo "<a href='#' onclick='nextPage()'><img src='img/right.png' style='width:40px'/></a>";
			echo "<a href='#' onclick='lastPage()'><img src='img/last.png' style='width:40px'/></a>";
        echo "</td></tr>";
	*/
	/*
	$nPaginas = $conta / 10;
