...
?>
    ...
    <body>
		...
		<div class="ink-grid">
			...
			<br/>
			<div class='large-50'>
				<h3><font color='#1A9018'>Vantagens e Beneficios</font></h3>
			</div>
			<div class='large-20'>&nbsp;</div>
			<div class='large-30 push-right'>
				<?php
				if(isset($_SESSION['id']) && $_SESSION['idTiposDePermissoes'] == 1){
					echo"<a href='editarVantagensBeneficios.php'><input type='button' class='ink-button' value='Editar Vantagens e Beneficios'></a>";
				}
				?>
			</div>
		</div>
